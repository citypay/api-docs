...
### Model BillPayment TokenRequest
...
---------|------|------|-------------|
 ...
 `notification-path` | object | Optional | [multi](#multi) Any notification paths for this bill payment to be executed. | 
...
| `notification-path` | object | false | [multi](#multi) Any notification paths for this bill payment to be executed. | 
